...
// }
//
// export default class CRequestOld extends CBase {
//    /**
//     * Proprietà protette.
//     * @protected
//     */
...
//    }
//    get request-old(): string {
//       return this._data.request-old;
//    }
//    get type(): number {
...
//    }
//    set request-old(value: string) {
//       this._data.request-old = value;
//    }
...
//       if(typeof id === "number")
//          this._data = this._select("request-old", CSqlGen.allField, [{
//             name: "id",
...
//       return this._select("request-old", CSqlGen.allField, where) as IRequest[];
//    }
//
//    /**
...
//                   {
//                      name: "request-old",
//                      value: [{sign: Sign.INCLUDE, option: Option.EQUAL, low: this.request-old}] as IOption[]
//                   },
//                   {
//                      name: "type",
...
//                        VALUES (${this.id}, ${this.getId(numericInterval.search)}, '${this.request-old}',
//                                '/request-old/${this.id}', 4)`);
//       this.executeRun(`INSERT INTO main.search (id, sequence, data, url, type)
